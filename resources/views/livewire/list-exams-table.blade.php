    ...
    <div class="card-body">
        ...
        :columns="[
            ...
            ['name' => 'Actions', 'type' => 'dropdown' , 'links' => [
                ['text' => 'edit', 'icon' => 'fas fa-cog', 'can' => 'update exam'],
                ['text' => 'Manage/View exam slots', 'icon' => 'fas fa-cog',  'can' => 'read exam slot'],
                ['text' => 'Create exam slots', 'icon' => 'fas fa-key',  'can' => 'create exam slot'],
            ]],
