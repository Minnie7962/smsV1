<div class="md:grid grid-cols-12 gap-2 w-full">
    ...
    <!-- Parent Information -->
    <h4 class="text-bold text-xl md:text-3xl col-span-12 text-center font-bold mt-8">Parent Information</h4>
    <div class="col-span-12">
        <div class="card">
            ...
            <div class="card-body grid grid-cols-12 gap-4">
                <x-input name="parent_first_name" id="parent-first-name" label="Parent First Name" placeholder="Parent's first name" group-class="col-span-6" />
                <x-input name="parent_last_name" id="parent-last-name" label="Parent Last Name" placeholder="Parent's last name" group-class="col-span-6" />
                <x-input name="parent_phone" id="parent-phone" label="Parent Phone" placeholder="Parent's phone number" group-class="col-span-6" />
                <x-input name="parent_email" id="parent-email" type="email" label="Parent Email" placeholder="Parent's email" group-class="col-span-6" />
                <x-input name="parent_address" id="parent-address" label="Parent Address" placeholder="Parent's address" group-class="col-span-12" />
            </div>
        </div>
    </div>
